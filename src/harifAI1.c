...

{
  ...
  /////////////user team tahlil////////////////////////
      ...
      while(i != 8)
      {
      if((paigah+i)->user == 1 && (paigah+i)->sarbaz->tedad_credit>0 ){if((paigah+i)->sarbaz->tedad_credit > (((user_team)-> shomare_paigah_ba_bishtarin_tedad)+1)){(user_team)-> shomare_paigah_ba_bishtarin_tedad= i;} (user_team)-> tedadekol+=(paigah+i)->sarbaz->tedad_credit;}
      ++i;
      }
             ...
             while((teamh+index)->shomare_paigah_ha[k] != -1)
             {
                if((paigah+(teamh+index)->shomare_paigah_ha[k])->sarbaz->tedad_credit > temp_tedad_sarbaz){
                  flag=1;
                    ...
                    if( (*(sarbazH_Harif+ *attack_number_Harif))->loc == -1){++k; continue;}
               ...
               if( (paigah+(teamh+index)->shomare_paigah_ha[k])->sarbaz->tedad_credit == 0){++k; continue;}
                    addlocation((teamh+index)->shomare_paigah_ha[k], paigah,*(sarbazH_Harif+ *attack_number_Harif));
                    add_destination(*(head_copy),paigah,*(sarbazH_Harif+ *attack_number_Harif));
                    addSarbazRuHava((*(sarbazH_Harif+ *attack_number_Harif))->tedadeshun,*(sarbazH_Harif+ *attack_number_Harif));
                    ++*attack_number_Harif;
         ...
         if((teamh+i)->tedadekol > (paigah+(user_team)-> shomare_paigah_ba_bishtarin_tedad)->sarbaz->tedadeshun)
         {
           int k=0;
             ...
             while((teamh+i)->shomare_paigah_ha[k] != -1)
             {
               ...
               if( (paigah+(teamh+i)->shomare_paigah_ha[k])->sarbaz->tedad_credit == 0){++k; continue;}
                    addlocation((teamh+i)->shomare_paigah_ha[k], paigah,*(sarbazH_Harif+ *attack_number_Harif));
                    add_destination((user_team)-> shomare_paigah_ba_bishtarin_tedad,paigah,*(sarbazH_Harif+ *attack_number_Harif));
                    addSarbazRuHava((*(sarbazH_Harif+ *attack_number_Harif))->tedadeshun,*(sarbazH_Harif+ *attack_number_Harif));
                    ++*attack_number_Harif;
...
{
  if(((paigah+ (user_team->hadaf))->user == 1))hamle_be_makane_khali();
...
///////////////////////////////////////////////////////////
       ...
       for(int i=0;i<*attack_number_Harif;++i)
      {
        if((*(sarbazH_Harif+i))->tedadeshun<=0){kamkardaneSarbazH(i,attack_number_Harif,sarbazH_Harif, head_sarbazRuHava_Harif);}
          ...
          destroy_sarbaz_beine_rah(sarbazH,attack_number,head_sarbazRuHava,sarbazH_Harif,attack_number_Harif,head_sarbazRuHava_Harif,paigah);
        ...
        if((*(sarbazH+i))->tedadeshun<=0){kamkardaneSarbazH(i,attack_number,sarbazH, head_sarbazRuHava);}
              ...
              *randd=rand()%1000;
               if(*randd>rand_for_potion && *randd<rand_for_potion_max )
               {
                 ...
                 {
                 case 1:
                   add_potion1(paigah,tedadeharif,360,120,200,200);
                   break;
                 case 2:
                   add_potion2(paigah,tedadeharif,360,120,200,200);
                 case 3:
                   add_potion3(paigah,tedadeharif,360,120,200,200);
                 case 4:
                   add_potion4(paigah,tedadeharif,360,120,200,200);
                 default:
                   break;
                 }      
               }
