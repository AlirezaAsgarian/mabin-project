(paigah2)-> hamsaye[0]=1;                                                                                                                                     (paigah2)->toolesh=1;
(paigah2+1)-> hamsaye[0]=0; (paigah2+1)-> hamsaye[1]=2;                                                                                                       (paigah2+1)->toolesh=2;
(paigah2+2)-> hamsaye[0]=1; (paigah2+2)-> hamsaye[1]=3;                                                                                                       (paigah2+2)->toolesh=2;
(paigah2+3)-> hamsaye[0]=2; (paigah2+3)-> hamsaye[1]=4;                                                                                                       (paigah2+3)->toolesh=2;
(paigah2+4)-> hamsaye[0]=3; (paigah2+4)-> hamsaye[1]=6;  (paigah2+4)-> hamsaye[2]=5;                                                                          (paigah2+4)->toolesh=3;
(paigah2+5)->hamsaye[0]=6; (paigah2+5)->hamsaye[1]=4;                                                                                                         (paigah2+5)->toolesh=2;
(paigah2+6)-> hamsaye[0]=5;                                                                                                                                   (paigah2+6)->toolesh=1;                                                                        
...
(queue+i)->arr=(int *)malloc(sizeof(int)*7);
(teamh+i)->shomare_paigah_ha=(int *)malloc(sizeof(int)*7);
(queue+i)->back[0]=0;
...
qsort((teamh+i)->shomare_paigah_ha,7, sizeof(int), cmpfunc);
}
free(k);
////////////////////////////////////////////////
///////////////////is_visited array/////////////
int *visited=(int *)malloc(sizeof(int)*7);

///////////////////////////////////////////////
///////////////////visited array///////////////
int *satle_queue=(int *)malloc(sizeof(int)*7); 
             ...
             while((teamh+index)->shomare_paigah_ha[k] != -1)
             {
                if((paigah2+(teamh+index)->shomare_paigah_ha[k])->sarbaz->tedad_credit > temp_tedad_sarbaz){
                  flag=1;
                    ...
                    add_destination3(*(head_copy),paigah2,*(sarbazH_Harif+ *attack_number_Harif));
             ...
             while((teamh+i)->shomare_paigah_ha[k] != -1)
             {
                if((paigah2+(teamh+i)->shomare_paigah_ha[k])->sarbaz->tedad_credit > temp_tedad_sarbaz){
                  flag=1;
                    ...
                    if( (*(sarbazH_Harif+ *attack_number_Harif))->loc == -1){++k;printf("oh mg////////////////;k'';k;k;k;'////////////////////////////////////////////// \n"); continue;}
                    add_destination3((user_team)-> shomare_paigah_ba_bishtarin_tedad,paigah2,*(sarbazH_Harif+ *attack_number_Harif));
                    addSarbazRuHava((*(sarbazH_Harif+ *attack_number_Harif))->tedadeshun,*(sarbazH_Harif+ *attack_number_Harif));
                    ++*attack_number_Harif;
                  break;
                  }
             ...
             while((teamh+i)->shomare_paigah_ha[k] != -1)
             {
                ...
                if((paigah2+(teamh+i)->shomare_paigah_ha[k])->sarbaz->tedad_credit > temp_tedad_sarbaz){
                  flag=1;
                    ...
                    addlocation((teamh+i)->shomare_paigah_ha[k], paigah2,*(sarbazH_Harif+ *attack_number_Harif));
                    if( (*(sarbazH_Harif+ *attack_number_Harif))->loc == -1){++k;printf("oh mg////////////////;k'';k;k;k;'////////////////////////////////////////////// \n"); continue;}
                    add_destination3((user_team->hadaf),paigah2,*(sarbazH_Harif+ *attack_number_Harif));
                    addSarbazRuHava((*(sarbazH_Harif+ *attack_number_Harif))->tedadeshun,*(sarbazH_Harif+ *attack_number_Harif));
                    ++*attack_number_Harif;
                  break;
                  }
...
///////////////////////////////////////////////////////////
      ...
      if(*flag)
      {
        ...
        continuetomove1((head_sarbazRuHava_Harif+i),*(sarbazH_Harif+i),i,sarbazH_Harif,attack_number_Harif,head_sarbazRuHava_Harif,paigah2);
