...
//     printf("moving\n");
     ...
     //   printf("(*(sarbazH_Harif+i))->is_destroy=%d i=%d *attack_number_Harif=%d\n",(*(sarbazH_Harif+i))->is_destroy,i,*attack_number_Harif);
        if((*(sarbazH_Harif+i))->is_destroy == 1){printf("hellojjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj\n"); kamkardaneSarbazH(i,attack_number_Harif,sarbazH_Harif, head_sarbazRuHava_Harif); --i; }
       //printf("i=%d\n",i);

       }*/
      printf("attack_number_Harif=%d attack_number=%d\n",*attack_number_Harif,*attack_number);
 //   printf("moving\n");
